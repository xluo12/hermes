...
public class UserDao {
    ...
    static {
        ...
        userMap.put(1001, new User(1001, "MXG-AA", "xiaomeng1", "123456", 2,
                3));
        userMap.put(1002, new User(1002, "MXG-BB", "xiaomeng2", "123456", 1,
                1));
        userMap.put(1003, new User(1003, "MXG-CC", "xiaomeng3", "123456", 1,
                2));
        userMap.put(1004, new User(1004, "MXG-DD", "xiaomeng4", "123456", 2,
                3));
        userMap.put(1005, new User(1005, "MXG-EE", "xiaomeng5", "123456", 1,
                2));
    }
