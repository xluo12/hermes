...
public class MavenWrapperDownloader {
    ...
    private static final String DEFAULT_DOWNLOAD_URL = "https://repo.maven" +
            ".apache.org/maven2/io/takari/maven-wrapper/0.4.2/maven-wrapper-0" +
            ".4.2.jar";
     ...
     */
    private static final String MAVEN_WRAPPER_PROPERTIES_PATH = ".mvn/wrapper" +
            "/maven-wrapper.properties";

    /**
     * Path where the maven-wrapper.jar will be saved to.
     */
    private static final String MAVEN_WRAPPER_JAR_PATH = ".mvn/wrapper/maven" +
            "-wrapper.jar";
